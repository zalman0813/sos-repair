      ...
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-gray-900" style={{ textShadow: '2px 2px 4px rgba(160, 160, 160, 0.5)' }}>{t.news.title}</span>
          </h2>
            ...
            >
              ...
              <div className="p-4 bg-gradient-to-r from-warm-yellow/10 to-warm-gold/10 backdrop-blur-sm">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-sm font-medium text-warm-yellow" style={{ textShadow: '1px 1px 2px rgba(128, 128, 128, 0.3)' }}>{t.news.viewInstagram}</span>
                </div>
              </div>
            </a>
          ))}
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-4 p-6 backdrop-blur-lg bg-gradient-to-r from-warm-yellow/20 to-warm-gold/20 rounded-2xl shadow-[0_8px_32px_0_rgba(251,146,60,0.15)] border border-warm-yellow/20 hover:from-warm-yellow/30 hover:to-warm-gold/30 transition-all duration-300">
            ...
            <div>
              <p className="text-warm-yellow font-semibold" style={{ textShadow: '1px 1px 2px rgba(128, 128, 128, 0.3)' }}>{t.news.followUs}</p>
              <p className="text-warm-yellow text-sm" style={{ textShadow: '1px 1px 2px rgba(128, 128, 128, 0.3)' }}>{t.news.handle}</p>
            </div>
          </div>
        </div>
      </div>
