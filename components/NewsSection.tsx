    ...
    <section id="news" className="section-padding bg-white">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {newsItems.map((item) => (
            ...
            >
              ...
              <div className="p-4 bg-gradient-to-r from-purple-50/50 to-pink-50/50 backdrop-blur-sm">
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-4 p-6 backdrop-blur-lg bg-gradient-to-r from-purple-50/40 to-pink-50/40 rounded-2xl shadow-[0_8px_32px_0_rgba(31,38,135,0.08)] border border-white/20 hover:from-purple-50/60 hover:to-pink-50/60 transition-all duration-300">
